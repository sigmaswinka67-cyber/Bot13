...
async def add_callback(callback: CallbackQuery):
    ...
    text = (
        "<b>Для добавления:</b>\n"
        "/arestuser @username YYYY-MM-DD YYYY-MM-DD\n"
        "или\n"
        "/arestuser @username 1-4 недель\n"
        "/arestuser @username 1-4 месяцев\n"
        "/arestuser @username ?"
    )
...
@router.message(Command("arestuser"))
...
@router.message(Command("drestuser"))
